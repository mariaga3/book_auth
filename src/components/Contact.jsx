  ...
  return (
    <div className={` h-screen flex items-center justify-center p-2 relative overflow-hidden ${theme === 'light'? 'bg-primary' : 'bg-black'}`}>
      ...
      <div className="bg-white rounded-lg shadow-xl overflow-hidden transition-all duration-300 flex max-w-3xl w-2/3 relative z-10">
        <div className="bg-primarydark text-black p-4 flex flex-col justify-between w-2/5 absolute left-2 top-2 bottom-2 rounded-lg shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
          <div>
            <h2 className="text-xl font-bold mb-3">Contact Me</h2>
            <div className="space-y-2 text-xs">
              <div className="flex items-center">
                <FaMapMarkerAlt className="mr-2 text-sky-300" />
                <p>23 Avenue de Paris 75012 Paris</p>
              </div>
              <div className="flex items-center">
                <FaEnvelope className="mr-2 text-sky-300" />
                <p>hello@mikechemardin.com</p>
              </div>
              <div className="flex items-center">
                <FaSkype className="mr-2 text-sky-300" />
                <p>Job Zirikana</p>
              </div>
              <div className="flex items-center">
                <FaPhone className="mr-2 text-sky-300" />
                <p>+33619530144</p>
              </div>
            </div>
          </div>
          <div className="flex space-x-3 mt-3">
            <FaInstagram className="text-sky-300 hover:text-white transition-colors" />
            <FaTwitter className="text-sky-300 hover:text-white transition-colors" />
            <FaLinkedin className="text-sky-300 hover:text-white transition-colors" />
          </div>
        </div>
        <div className="p-4 w-3/5 ml-auto">
          ...
          <form className="space-y-2">
            ...
            <button type="submit" className="bg-sky-400 text-white px-6 py-1.5 text-sm rounded-full hover:bg-sky-500 transition-colors">
              SEND
            </button>
          </form>
        </div>
